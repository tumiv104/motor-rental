 ...
 * @author hungv
 */
public class MDeleteMotorbikeServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MDeleteMotorbikeServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MDeleteMotorbikeServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            boolean isDeleted = motorbikeDAO.deleteMotorbike(motorbikeId);
            if (isDeleted) {
